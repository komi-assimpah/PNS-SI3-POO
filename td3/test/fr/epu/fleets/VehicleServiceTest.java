...
class VehicleServiceTest {
    ...
    void setUp() {
        ...
        System.out.println("electricVehicle range: " + electricVehicle.distanceCanMoveWithBatteryCapacityMax() + " km");
        System.out.println("electricVehicle distance: " + electricVehicle.distanceCanMoveWithCurrentCharge() + " km");
        ebike = new ElectricBike(15, new double[]{0.15, 0.5, 0.8});
        System.out.println("ebike range: " + ebike.distanceCanMoveWithBatteryCapacityMax() + " km");
        System.out.println("ebike distance: " + ebike.distanceCanMoveWithCurrentCharge() + " km");
        ecar = new ElectricCar(40, "AB-125-XS");
        ecar.turnOnCoolingSystem();
        System.out.println("ecar range: " + ecar.distanceCanMoveWithBatteryCapacityMax() + " km");
        System.out.println("ecar distance: " + ecar.distanceCanMoveWithCurrentCharge() + " km");
    }
